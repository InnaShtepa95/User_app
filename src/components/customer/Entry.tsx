...
class Entry extends React.Component<RouteComponentProps<any>, IFormState> {
                            ...
                            <div className={"col-md-12 form-wrapper"}>
                                ...
                                <form id={"create-post-form"} onSubmit={this.processFormSubmission} noValidate={true}>
                                    ...
                                    <div className="form-group col-md-12">
                                        ...
                                        <input type="text" id="birth_day" defaultValue={this.state.customer.birth_day} onChange={(e) => this.handleInputChanges(e)} name="birth_day" className="form-control" placeholder="Enter customer's birth_day" />
                                    </div>
